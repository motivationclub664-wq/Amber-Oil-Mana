...
(async () => {
  ...
  try {
    await client.query('ALTER TABLE orders ADD COLUMN IF NOT EXISTS total INT');
    await client.query('ALTER TABLE orders ADD COLUMN IF NOT EXISTS discount NUMERIC(5,2)');
